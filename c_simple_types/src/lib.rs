...
// The parameter (x, y): (f32, f32) destructures the tuple into its components directly within the function's signature.
pub fn print_distance((x, y): (f32, f32)) {
    // Now we use x and y directly instead of z.0 and z.1
    println!(
        "Distance to the origin is {}",
